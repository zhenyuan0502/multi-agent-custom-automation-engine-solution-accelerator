...
import {
  ...
  PanelRightExpand,
  TreeDeciduous,
} from "@/coral/imports/bundleicons";
        ...
        <Content>
          ...
          {!loading && (
            <>
              ...
              >
                <PanelRightToggles>
                  <Button panelToggleIcon appearance="transparent" />
                </PanelRightToggles>
              </ContentToolbar>
              <PlanChat planData={planData} OnChatSubmit={handleOnchatSubmit} />
            </>
          )}
        </Content>
