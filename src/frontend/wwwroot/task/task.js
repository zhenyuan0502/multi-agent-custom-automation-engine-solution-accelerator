                    ...
                    .then(data => {
                        ...
                        if (data && data.length > 0) {
                            ...
                            data.forEach(stage => {
                                ...
                                stageItem.innerHTML = `
                                <a class="menu-stage ${stage.status} ${stageRejected}" data-id="${stage.id}" title="Status: ${stage.status}, Id: ${stage.id}">
                                    ${stageStatusIcon}
                                    <span>${taskStageCount + 1}. ${stage.action}</span>
                                    ${stageActions}
                                </a>
                                `;
                    ...
                    .then(data => {
                        ...
                        if (data) {
                            ...
                            Object.keys(groupedData).forEach(stage => {
                                ...
                                messageGroupItem.innerHTML = (stageCount === 0) ? '<legend>Planning</legend>' : `<legend>Stage ${stageCount}</legend>`;
